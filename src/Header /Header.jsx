...
export const Header = () => {
  ...
  const [avatarImage, setAvatarImage] = useState(localStorage.getItem("avatarImage") || null); // Estado para armazenar a imagem do avatar
              ...
              {myLink.map((item, index) => (
                <Link
                  ...
                  style={{
                    ...
                    background:
                      item.link === location.pathname && "#3cb815",
                    boxShadow:
                      item.link === location.pathname &&
                      "rgba(14, 30, 37, 0.12) 0px 2px 4px 0px, rgba(14, 30, 37, 0.32) 0px 2px 16px 0px",
                    borderRadius:
                      item.link === location.pathname && "5px",
                    padding: "5px",
                  }}
                >
                  {item.label}
            ...
            >
              ...
              <Box sx={{
                ...
                <span onClick={abrirMenu}>
                  {abreMeno ? <CloseIcon sx={{fontSize: '25px'}}  /> : <DehazeIcon sx={{fontSize: '25px'}} />}
                </span>
              </Box>
            </Stack>
          </Stack>
